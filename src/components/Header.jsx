...
const MENU_ITEMS = [
  ...
  { id: "coparent", label: "Invite Co-Parent", icon: "M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2|M8.5 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8|M20 8v6|M23 11h-6" },
...
export default function Header({ displayName, onOpenProfile, onOpenPage, onLogoClick, onSignOut, unreadCount, onOpenActivity, onInviteCoParent }) {
