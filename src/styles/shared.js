...
export const s = {
  ...
  kidAvatar: { width: 40, height: 40, borderRadius: 12, background: `linear-gradient(135deg, ${C.seaGreen}, ${C.blue})`, color: C.cream, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Poppins', sans-serif", fontSize: 18, fontWeight: 700, flexShrink: 0 },
