...
export function useDataFreshness() {
  // Auto-set to build date so it updates whenever code is deployed
  const dataVersion = new Date(__BUILD_DATE__).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" });
