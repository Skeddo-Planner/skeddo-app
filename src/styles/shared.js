...
export const s = {
  ...
  header: { background: C.white, padding: "20px 20px 16px", borderBottom: `1px solid ${C.border}` },
  headerRow: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  logoMark: { fontFamily: "'Poppins', sans-serif", fontSize: 26, color: C.cream, letterSpacing: -0.5, lineHeight: 1 },
  ...
  addButton: { fontFamily: "'Barlow', sans-serif", fontSize: 14, fontWeight: 700, color: "#FFFFFF", background: C.seaGreen, border: "none", borderRadius: 10, padding: "11px 18px", cursor: "pointer", minHeight: 44 },
  ...
  cardName: { fontFamily: "'Barlow', sans-serif", fontSize: 17, fontWeight: 700, color: C.ink, lineHeight: 1.3 },
  ...
  input: { width: "100%", fontFamily: "'Barlow', sans-serif", fontSize: 16, fontWeight: 500, border: `1.5px solid ${C.border}`, borderRadius: 10, padding: "10px 14px", color: C.ink, background: C.cream, transition: "all 0.15s" },
  primaryBtn: { flex: 2, fontFamily: "'Barlow', sans-serif", fontSize: 16, fontWeight: 700, background: C.seaGreen, color: "#FFFFFF", border: "none", borderRadius: 10, padding: "12px 16px", cursor: "pointer", minHeight: 44 },
  secondaryBtn: { flex: 1, fontFamily: "'Barlow', sans-serif", fontSize: 16, fontWeight: 700, background: C.cream, color: C.muted, border: `1.5px solid ${C.border}`, borderRadius: 10, padding: "12px 16px", cursor: "pointer", minHeight: 44 },
  dangerBtn: { fontFamily: "'Barlow', sans-serif", fontSize: 14, fontWeight: 700, background: C.dangerBg, color: C.danger, border: "none", borderRadius: 10, padding: "12px 14px", cursor: "pointer", transition: "all 0.15s", minHeight: 44 },
  ...
  searchBox: { width: "100%", fontFamily: "'Barlow', sans-serif", fontSize: 16, fontWeight: 500, border: `1.5px solid ${C.border}`, borderRadius: 12, padding: "11px 14px 11px 38px", color: C.ink, background: C.white, transition: "all 0.15s" },
};
