...
const MENU_ITEMS = [
  ...
  { id: "bug", label: "Report a Bug", icon: "M8 2v4|M16 2v4|M3 10h18|M21 6v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6", openProfile: "bug" },
  { id: "feedback", label: "Leave Feedback", icon: "M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z", openProfile: "feedback" },
...
export default function Header({ displayName, onOpenProfile, onOpenPage, onLogoClick, onSignOut, unreadCount, onOpenActivity, onDismissActivity, onDismissAllActivity, onInviteCoParent, tab, setTab, badges, activityLog = [] }) {
  ...
  const handleItemClick = (id) => {
    ...
    if (item?.openProfile) {
      onOpenProfile && onOpenProfile(item.openProfile);
    } else if (id === "coparent") {
